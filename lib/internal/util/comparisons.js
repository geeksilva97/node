...
function innerDeepEqual(val1, val2, strict, memos) {
  console.log('val2 should be asymetric', {
  ...
  if (strict) {
    ...
    if (typeof val2 !== 'object' ||
      ...
      if (val2.type === Symbol.for('asymetric.matcher')) {
  ...
  console.log('am i here?', { val1Tag, val2Tag })
  ...
  if (ArrayIsArray(val1)) {
    ...
    console.log('gotta do a key check')
...
function keyCheck(val1, val2, strict, memos, iterationType, aKeys) {
  ...
  if (memos === undefined) {
    ...
    console.log('gotta do obj equiv')
