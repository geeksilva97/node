...
function formatValue(ctx, value, recurseTimes, typedArray) {
  ...
  if ((typeof value !== 'object' &&
      ...
      !isUndetectableObject(value)) || value.type === Symbol.for('asymetric.matcher')) {

    if (value.type === Symbol.for('asymetric.matcher')) {
      return formatPrimitive(ctx.stylize, value.toString(), ctx);
    }
