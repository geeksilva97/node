...
describe('Buffer.prototype.getReader', () => {
  it('returns a BufferReader instance', (t) => {
    ...
    t.equal(typeof reader.read, 'function');
    t.equal(typeof reader.seek, 'function');
  });
  ...
  it('BufferReader.prototype.read gets n bytes from actual buffer', (t) => {
    ...
    t.deepEqual(result1, Buffer.from([0xca, 0xfe]));
    t.deepEqual(result2, Buffer.from([0xba, 0xbe]));
  });
  ...
  it('BufferReader.prototype.seek sets the position', (t) => {
    ...
    t.deepEqual(result1, Buffer.from([0xca, 0xfe]));
    t.deepEqual(result2, Buffer.from([0xca, 0xfe]));
  });
});
